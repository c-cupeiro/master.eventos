...
public class EventoDetalles extends AppCompatActivity {
    ...
    public void subirAFirebaseStorage(Integer opcion,
        ...
        final ProgressDialog progresoSubida = ProgressDialog.show(
                EventoDetalles.this, "Espere ...", "Subiendo ...", true);
    ...
    public void eliminardeFirebaseStorage() {
        ...
        alertDialog.setTitle("Eliminar Fichero Firebase:");
        alertDialog.setMessage("¿Desea borrar el elemento?");
